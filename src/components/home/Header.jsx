                    ...
                    <div className="row">
                      <div className="col-md-12">
                        <div className="flexcols">
                          ...
                          <div
                            id="main-navigation"
                            className={`navigation-header ${isMobileMenuOpen ? "open" : ""}`}
                            style={{
                              "--mb2mm-hfs": "1rem",
                              "--mb2mm-hifs": "1rem",
                              "--mb2mm-hfw": "var(--mb2-pb-fwbold)",
                              "--mb2mm-mcminwidth": "240px",
                              "--mb2mm-mcminheight": "80px",
                              "--mb2mm-mddbgcolor": "var(--mb2mm-ddbgcolor)",
                            }}
                          >
                            {/* Mobile Extra Content */}
                            <div className="mnavtop menu-extracontent">
                              <div
                                className="menu-extracontent-controls d-flex flex-row justify-content-center align-items-center"
                                role="tablist"
                              >
                                <button
                                  id="btn-menu-searchcontainer"
                                  className="themereset p-0 menu-extra-controls-btn menu-extra-controls-search d-inline-flex flex-column justify-content-center align-items-center"
                                  role="tab"
                                  aria-controls="menu-searchcontainer"
                                  aria-expanded={activeTab === "search"}
                                  onClick={() =>
                                    setActiveTab(
                                      activeTab === "search" ? null : "search",
                                    )
                                  }
                                >
                                  <i
                                    className="icon1 ri-search-line"
                                    aria-hidden="true"
                                  ></i>
                                  <i
                                    className={`icon2 ${activeTab === "search" ? "" : "d-none"} ri-close-large-line`}
                                    aria-hidden="true"
                                  ></i>
                                  <span className="d-block mt-1 label tsizexxsmall">
                                    Search
                                  </span>
                                </button>
                                <button
                                  id="btn-menu-logincontainer"
                                  className="themereset p-0 menu-extra-controls-btn menu-extra-controls-login d-inline-flex flex-column justify-content-center align-items-center"
                                  role="tab"
                                  aria-controls="menu-logincontainer"
                                  aria-expanded={activeTab === "login"}
                                  onClick={() =>
                                    setActiveTab(
                                      activeTab === "login" ? null : "login",
                                    )
                                  }
                                >
                                  <i
                                    className="icon1 ri-lock-line"
                                    aria-hidden="true"
                                  ></i>
                                  <i
                                    className={`icon2 ${activeTab === "login" ? "" : "d-none"} ri-close-large-line`}
                                    aria-hidden="true"
                                  ></i>
                                  <span className="d-block mt-1 label tsizexxsmall">
                                    Log in
                              ...
                              {/* Search Container */}
                              <div
                                id="menu-searchcontainer"
                                className={`menu-extracontent-content menu-searchcontainer ${activeTab === "search" ? "" : "d-none"}`}
                                role="tabpanel"
                                aria-labelledby="btn-menu-searchcontainer"
                              >
                              ...
                              {/* Login Container */}
                              <div
                                id="menu-logincontainer"
                                className={`menu-extracontent-content menu-logincontainer theme-loginform ${activeTab === "login" ? "" : "d-none"}`}
                                role="tabpanel"
                                aria-labelledby="btn-menu-logincontainer"
                              >
                                <div className="form-inner">
                                  ...
                                  >
                                    <div className="form-field">
                                      <label htmlFor="menu-login-username">
                                    ...
                                    <div className="form-field">
                                      <label htmlFor="menu-login-password">
                            ...
                            <ul
                              id="mb2mm_1"
                              className="mb2mm ddrounded0 chupper1 mb2mm-mcis_border cpadding_small"
                            >
                              <li className="level-1 isparent onhover ismega">
                                <button
                                  type="button"
                                  className="mb2mm-action themereset"
                                >
                                  <span className="mb2mm-item-content">
                                    <span className="mb2mm-label">Demos</span>
                                  </span>
                                  <span className="mb2mm-arrow"></span>
                                </button>
                                <button
                                  type="button"
                                  className="mb2mm-toggle themereset"
                                  aria-label="Open submenu of Demos"
                                  aria-expanded="false"
                                ></button>
                              ...
                              <li className="level-1">
                                <a
                                  className="mb2mm-action"
                                  href="https://lmsstyle.com/theme/new-learning/course/view.php?id=7"
                                >
                                  <span className="mb2mm-item-content">
                                    <span className="mb2mm-label">
                                      Features
                                    </span>
                                  </span>
                                </a>
                              ...
                              <li className="level-1">
                                <a
                                  className="mb2mm-action"
                                  href="https://lmsstyle.com/theme/new-learning/course"
                                >
                                  <span className="mb2mm-item-content">
                                    <span className="mb2mm-label">
                                      All courses
                              ...
                              <li className="level-1">
                                <a
                                  className="mb2mm-action"
                                  href="https://lmsstyle.com/theme/new-learning/blog/index.php"
                                >
                                  <span className="mb2mm-item-content">
                                    <span className="mb2mm-label">Blog</span>
                                  </span>
                                </a>
                              </li>
                            </ul>
                          ...
                          <div className="header-tools tools-pos2 hnavtype1">
                            <div className="theme-plugins"></div>
                            <div
                              id="themeskipto-search"
                              className="sr-only sr-only-focusable"
                            ></div>
                            <button
                              type="button"
                              id="theme-search-btn"
                              className="header-tools-link tool-search themereset"
                              data-id="search"
                              aria-label="Search"
                              data-toggle="modal"
                            ...
                            >
                              <i className="icon1 ri-search-line"></i>
                              <span className="text1">Search</span>
                            </button>
                            <div
                              id="themeskipto-login"
                              className="sr-only sr-only-focusable"
                            ></div>
                            <button
                              type="button"
                              className="header-tools-link loginbtn mb2-pb-btn isicon1 typeprimary rounded1 tool-login"
                              data-id="login"
                              data-toggle="modal"
                              data-target="#header-modal-login"
                              data-bs-toggle="modal"
                            ...
                            >
                              <span className="btn-icon" aria-hidden="true">
                                <i className="icon1 ri-lock-line"></i>
                              </span>
                              <span className="text1">Log in</span>
                            </button>
                            <button
                              type="button"
                              className="header-tools-link header-mtools-link mtool-login"
                            >
